package com.eclipse.findz.screen.tutorial
            ...
            Box(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        modifier = Modifier
                            .size(24.dp)
                            .clickable { navController.navigate("tutorial2") }
                    )
...
//                )
            ...
            Box(
                ...
                Text(
                    text = stringResource(id = R.string.tutor3),
                    fontFamily = soraFontFamily,
                    fontSize = 12.sp,
            ...
            Button(
                onClick = { navController.navigate("tutorial4") },
                modifier = Modifier
                    .fillMaxWidth()
